...
public class Category {
	...
	public static ArrayList<ArrayList<String>> earningProduct(){
		...
		String sql = "SELECT c.category, COUNT( * ) " +
				" FROM earnings e" +
		...
		try{
			...
			while(rs.next()){
				...
				rec.add(rs.getString("c.category"));
	...
	public static ArrayList<ArrayList<String>> earningAgeProduct(String age){
        ...
        if(age == "60"){
        	sql = "SELECT c.category, COUNT( * )  as c_earnings, age"+
        			" FROM earnings e"+
        			" INNER JOIN product p ON p.id = e.product_id"+
        			" INNER JOIN member m ON m.id = e.member_id"+
        			" INNER JOIN category c ON c.id = p.category_id"+
        	...
        	sql = "SELECT c.category, COUNT( * )  as c_earnings"+
        		" FROM earnings e"+
        		" INNER JOIN product p ON p.id = e.product_id"+
        		" INNER JOIN member m ON m.id = e.member_id"+
        		" INNER JOIN category c ON c.id = p.category_id"+
		...
		try{
			...
			while(rs.next()){
				...
				rec.add(rs.getString("c.category"));
				System.out.println(rs.getString("c.category"));
